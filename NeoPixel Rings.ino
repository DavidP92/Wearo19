...
void colorSwitch(byte colorNumber){
  ...
  switch(colorNumber){
    case 1:               //Red
      ...
      break;
    case 2:               //Blue
      setPColor(&strip0, b, 150); 
      setPColor(&strip1, b, 150); 
      setPColor(&strip2,b,150);
    ...
    case 5:               //Rainbow Effect
      ...
      rainbow(&strip3,10);
    case 6: 
      setPColor(&strip0, f, 150);  //Turn Off
      setPColor(&strip1, f, 150); // Turn Off
      setPColor(&strip2, f, 150);
      setPColor(&strip3, g, 255);
  }
}
